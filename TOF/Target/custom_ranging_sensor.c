...
static const CUSTOM_VL53L7CX_Config_t VL53L7CX_Config[] = {
  {
    .I2C_Address = RANGING_SENSOR_VL53L7CX_ADDRESS,
    .I2C_Init = CUSTOM_VL53L7CX_I2C_INIT,
    .I2C_DeInit = CUSTOM_VL53L7CX_I2C_DEINIT,
    .I2C_WriteReg = CUSTOM_VL53L7CX_I2C_WRITEREG,
    .I2C_ReadReg = CUSTOM_VL53L7CX_I2C_READREG,
    .PWR_EN_Port = CUSTOM_VL53L7CX_PWR_EN_PORT,
    .PWR_EN_Pin = CUSTOM_VL53L7CX_PWR_EN_PIN,
    .LPn_Port = CUSTOM_VL53L7CX_LPn_PORT,
    .LPn_Pin = CUSTOM_VL53L7CX_LPn_PIN
  },
  {
    .I2C_Address = RANGING_SENSOR_VL53L7CX_ADDRESS,
    .I2C_Init = CUSTOM_VL53L7CX_I2C_INIT2,
    .I2C_DeInit = CUSTOM_VL53L7CX_I2C_DEINIT2,
    .I2C_WriteReg = CUSTOM_VL53L7CX_I2C_WRITEREG2,
    .I2C_ReadReg = CUSTOM_VL53L7CX_I2C_READREG2,
    .PWR_EN_Port = CUSTOM_VL53L7CX_PWR_EN_PORT2,
    .PWR_EN_Pin = CUSTOM_VL53L7CX_PWR_EN_PIN2,
    .LPn_Port = CUSTOM_VL53L7CX_LPn_PORT2,
    .LPn_Pin = CUSTOM_VL53L7CX_LPn_PIN2
  }
};
...
static VL53L7CX_Object_t   VL53L7CXObj[CUSTOM_RANGING_INSTANCES_NBR];
...
static int32_t VL53L7CX_Probe(uint32_t Instance)
{
  ...
  IOCtx.Address     = VL53L7CX_Config[Instance].I2C_Address;
  IOCtx.Init        = VL53L7CX_Config[Instance].I2C_Init;
  IOCtx.DeInit      = VL53L7CX_Config[Instance].I2C_DeInit;
  IOCtx.WriteReg    = VL53L7CX_Config[Instance].I2C_WriteReg;
  IOCtx.ReadReg     = VL53L7CX_Config[Instance].I2C_ReadReg;
  ...
  else
  {
    ...
    CUSTOM_RANGING_CompObj[Instance] = &VL53L7CXObj[Instance];
...
{
#if (USE_CUSTOM_RANGING_VL53L7CX == 1U)
  HAL_GPIO_WritePin(VL53L7CX_Config[Instance].PWR_EN_Port, VL53L7CX_Config[Instance].PWR_EN_Pin, GPIO_PIN_RESET);
  HAL_Delay(2);
  HAL_GPIO_WritePin(VL53L7CX_Config[Instance].PWR_EN_Port, VL53L7CX_Config[Instance].PWR_EN_Pin, GPIO_PIN_SET);
  HAL_Delay(2);
  HAL_GPIO_WritePin(VL53L7CX_Config[Instance].LPn_Port, VL53L7CX_Config[Instance].LPn_Pin, GPIO_PIN_RESET);
  HAL_Delay(2);
  HAL_GPIO_WritePin(VL53L7CX_Config[Instance].LPn_Port, VL53L7CX_Config[Instance].LPn_Pin, GPIO_PIN_SET);
  HAL_Delay(2);
#endif /* Use custom ranging */
}
