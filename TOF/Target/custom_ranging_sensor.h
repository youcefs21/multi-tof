...
#define CUSTOM_RANGING_INSTANCES_NBR    (2U)

#define CUSTOM_VL53L7CX_DEV1 (0U)
#define CUSTOM_VL53L7CX_DEV2 (1U)
...
typedef struct
{
  ...
  int32_t (*I2C_WriteReg)(uint16_t, uint16_t, uint8_t *, uint16_t);
  int32_t (*I2C_ReadReg)(uint16_t, uint16_t, uint8_t *, uint16_t);
  GPIO_TypeDef *PWR_EN_Port;
  uint16_t PWR_EN_Pin;
  GPIO_TypeDef *LPn_Port;
  uint16_t LPn_Pin;
} CUSTOM_VL53L7CX_Config_t;
